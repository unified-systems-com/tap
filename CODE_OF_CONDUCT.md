...
Two addresses, and the difference between them matters.
...
report would pass through the person it might concern.
...
Service apply to these repositories and are outside this project's control.
Anyone uncomfortable raising a matter internally may use that channel instead.

## Delegated and automated work
...
that consume maintainer attention are covered whether or not any individual
message is uncivil. The harm is the aggregate, and it is paid in the finite
attention of people who could have been building or fixing something.

## What this Code does not cover

Some things read like conflict and are the project working as intended.

- **Rigorous technical review is not a violation.** Sharp, specific,
  substantiated criticism of a change is the job. What is out of bounds is
  directing it at the person rather than the work.
- **Declining a contribution is not a violation**, and declining to spend review
  effort on generated output the contributor has not themselves read,
  understood, and stood behind is legitimate. Asking someone to demonstrate that
  understanding is a reasonable request, not an accusation.
- **Being overruled is not a violation.** Technical disagreement is resolved
  under `GOVERNANCE.md`. Arguing that a decision was taken at the wrong level is
  welcome — as an issue, not as a report under this Code.
...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the community leaders responsible for enforcement at conduct@unified-systems.com, or steward@unified-systems.com for a report about the maintainer role (see "Where to report" above). All complaints will be reviewed and investigated promptly and fairly.
...
The Code of Conduct above is the Contributor Covenant, version 2.1, used under
[CC BY 4.0](https://creativecommons.org/licenses/by/4.0/). The only change to
its text is the contact method, which the Covenant leaves as a placeholder to be
filled in by the adopting project. The preamble at the top of this file is
additional material written for this project and is not part of the Covenant.
