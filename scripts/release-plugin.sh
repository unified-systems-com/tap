...
info "  (asks the forge which commit $TAG names, then writes rev + commit as one pair — tap#513."
info "   Needs network, and refuses rather than writing a pin it could not verify.)"
