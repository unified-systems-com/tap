...
TAP-IMPLEMENTS: req-tap-json-naming@92f581d7ed1d/4db993fbae1c (enforcement) — the guard
...
`<name>.<role>.json` (role in {boot, secret, grift, edge, gridkin, cascade, batch}), singleton app
