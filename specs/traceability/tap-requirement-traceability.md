...
| `req-tap-traceability-disposition` | Implemented | Verified | `<module>`, `_parse_disposition` | `req-tap-traceability-disposition-6` |
| `req-tap-traceability-disputed` | Implemented | Implemented | `disputed` | — |
| `req-tap-traceability-fragments` | Implemented | Verified | `render_traceability_fragments`, `sync_traceability_fragments`, `fragment_drift` | `req-tap-traceability-fragments-1`, `req-tap-traceability-fragments-2`, `req-tap-traceability-fragments-3`, `req-tap-traceability-fragments-4` |
