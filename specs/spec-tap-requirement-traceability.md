...
**1152** requirements · **171** mapped · **47** excluded (external 11, narrative 4, non-python 25, process 7) · **20** doctrine · **0** disputed · **561** unbuilt · **16** retired · **337 Unaccounted** · **142** built with zero ACIDs (Verified-unreachable).
