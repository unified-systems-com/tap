...
| Gryphon read scope | `req-grid-traversal-exec-read-scope` | Per-commit (`pytest`) | CI-guarded | `tap_grid.guards.gryphon_read_scope` (via `tap/tests/test_guards.py`) |
